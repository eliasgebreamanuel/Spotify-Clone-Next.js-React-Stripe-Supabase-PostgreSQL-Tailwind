...
const PlayerContent: React.FC<PlayerContentProps> = ({ song, songUrl }) => {
  ...
  const onPlayNext = () => {
    ...
    if (!nextSong) {
      return player.sdetId(player.ids[0]);
    }
  ...
  const onPlayPrevious = () => {
    ...
    if (!previousSong) {
      return player.sdetId(player.ids[player.ids.length - 1]);
    }
  ...
  return (
    ...
    <div className="hidden h-full md:flex justifu-center items-center w-full mx-w-[722px] gap-x-6">
        <AiFillStepBackward
